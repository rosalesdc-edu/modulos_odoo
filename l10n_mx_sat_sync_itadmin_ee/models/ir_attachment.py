...
class IrAttachment(models.Model):
    ...
    invoice_ids = fields.One2many("account.invoice",'attachment_id',"Invoices")
    invoice_count = fields.Integer(compute='_compute_account_invoice_count', string='# of Invoices', store=True)
